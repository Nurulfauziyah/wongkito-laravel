...
<head>
  ...
  <title>Admin Uci | Edit Produk</title>
              ...
              <form method="POST" action="{{route ('update', $data->id)}}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{ $data->name }}"id="produkname" placeholder="Masukkan Nama" name="name">
                  </div>
                  <div class="form-group">
                    <label for="description">Deskripsi</label>
                    <input type="text" class="form-control" value="{{ $data->description }}"id="description" placeholder="deskripsi" name="desc">
                  </div>
                  <div class="form-group">
                    <label for="link">Link</label>
                    <input type="text" class="form-control" value="{{ $data->link }}" id="link" placeholder="Masukkan link whatsapp" name="link">
                  </div>
                   <div class="form-group">
                    <label for="price">Price</label>
                    <input type="text" class="form-control" value="{{ $data->price }}" id="price" placeholder="Masukkan Price" name="price">
                  </div>
                  <div class="form-group">
