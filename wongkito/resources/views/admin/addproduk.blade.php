...
<head>
  ...
  <title>Admin Uci | Add Product</title>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              ...
              <!-- form start -->
              <form method="POST" action="{{route ('SimpanProduk')}}" id="myForm" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="produkname">Nama</label>
                    <input type="text" class="form-control" id="produkname" placeholder="Masukkan Nama" name="name">
                  </div>
                  <div class="form-group">
                    <label for="description">Deskripsi</label>
                    <input type="text" class="form-control" id="description" placeholder="deskripsi" name="desc">
                  </div>
                  <div class="form-group">
                    <label for="link">Link</label>
                    <input type="text" class="form-control" id="link" placeholder="Masukkan link whatsapp" name="link">
                  </div>
                   <div class="form-group">
                    <label for="price">Price</label>
                    <input type="text" class="form-control" id="price" placeholder="Masukkan Price" name="price">
                  </div>
                  <div class="form-group">
